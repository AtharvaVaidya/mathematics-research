...
- the stronger all-flow simultaneous-external census on the same 138,144
...
- the human marked-root cap decomposition and self-contained edge-rooted
  cutoff to cap order 58 and parent order 116, together with
...
- N. Alon, S. Hoory, and N. Linial, *The Moore Bound for Irregular Graphs*,
  Graphs and Combinatorics 18 (2002), 53--57.  Their bound is the standard
  context for the new self-contained edge-rooted degree-deficit count.
- N. Afzaly and B. D. McKay, online *Extremal Graphs and Turan numbers*
  data.  Their reported exact girth-at-least-ten values would imply the
  stronger cap order 64 and parent order 128.  The site describes papers
  as in preparation, and this project does not retain a proof of the
  exhaustive upper bounds, so the stronger conclusion is not promoted to
  the manuscript's self-contained theorem.
