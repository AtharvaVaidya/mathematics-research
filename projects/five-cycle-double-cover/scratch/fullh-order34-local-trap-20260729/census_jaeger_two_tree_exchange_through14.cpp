...
#ifndef JAEGER_AUDIT_MAX_N
#define JAEGER_AUDIT_MAX_N 14
#endif
#ifndef JAEGER_AUDIT_MAX_M
#define JAEGER_AUDIT_MAX_M 21
#endif
constexpr int MAX_N = JAEGER_AUDIT_MAX_N;
constexpr int MAX_M = JAEGER_AUDIT_MAX_M;
