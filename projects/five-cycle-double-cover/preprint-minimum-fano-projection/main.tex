...
through size eleven, and gives exact finite censuses.  It proves neither the
...
eleven is cleanable, and a counterexample to the proposed selection
principle must have minimum size at least twelve.
...
given here.  By Theorem~\ref{thm:sizeeleven}, any counterexample to this
selection principle has minimum support at least twelve.
...
Theorems~\ref{thm:sizefive}, \ref{thm:sizeseven}, \ref{thm:sizeten}, and
\ref{thm:sizeeleven} close every possible nonzero support size through
eleven:
a counterexample to Conjecture~\ref{conj:minimum} must have minimum
projection size at least twelve.
