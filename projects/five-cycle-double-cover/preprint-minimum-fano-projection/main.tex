...
through size twelve, and gives exact finite censuses.  It proves neither the
...
size at most twelve is cleanable, and a counterexample to the proposed
selection principle must have minimum size at least thirteen.
...
\subsection{Clean or delete at size twelve}
...
given here.  By Theorem~\ref{thm:sizetwelve}, any counterexample to this
selection principle has minimum support at least thirteen.
...
\ref{thm:sizeeleven}, and \ref{thm:sizetwelve} close every possible
nonzero support size through twelve:
a counterexample to Conjecture~\ref{conj:minimum} must have minimum
projection size at least thirteen.
