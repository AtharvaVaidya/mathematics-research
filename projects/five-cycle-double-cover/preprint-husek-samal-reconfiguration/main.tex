...
counterexamples only to a proposed radius-one flow-reconfiguration lemma
and a separate radius-two Jaeger-star reciprocal-exchange lemma.
...
radius-one formulation, the reciprocal-exchange obstruction, and the
finite certificates may be new, but that assessment is provisional.
