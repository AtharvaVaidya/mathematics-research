...
manuscript proves a difference-rank normal form, a short
...
values and give an exact criterion for legal distance two.  A smallest
\(K_{3,3}\) example and a smallest cube bad-to-good example have
unrestricted distance two but legal distance three.
