...
span, quadratic obstructions, and unbounded kernel complexity}
...
\colorbox{yellow!22}{%
  ...
  cotree--diamond iteration, wrote the search and checking programs, and
  drafted this manuscript under human direction.  The checkers and the
  present proof exposition are themselves
...
\(d+1\) components.  Explicit flows attain equality.
...
\]
Equality is attained.  Their orders begin
\[
                         10,34,106,322,\ldots
\]
...
ends.  Exactly one line component is therefore added at every stage,
giving equality in (5.3).
...
five-cover equation, and exact line-component counts \(1,2,3,4\).
...
also did not locate the unbounded kernel-line component theorem.
...
\begin{enumerate}
  ...
  \item two structural limitations: a matching-contraction obstruction
        instantiated by a small fixed-projection counterexample, and an
