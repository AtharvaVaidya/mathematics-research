...
3-connectivity, so Corollary~\ref{cor:tait-path} states that premise
explicitly.  The simple-cap hypotheses alone establish
3-edge-connectivity; they must not be silently promoted to
