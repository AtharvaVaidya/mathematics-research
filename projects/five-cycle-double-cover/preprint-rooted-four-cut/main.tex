...
record seven narrowly scoped results.
...
An audited companion reduction tracks a fork triple
\(\{qr,ps,pt\}\) through endpoint-triangle contractions and would
exclude the remaining mixed cyclic-three relation once a
triangle-free, 3-connected finite premise through the required order
is certified.  That computation was still running when this draft was
frozen; it is not one of the finite theorems claimed here, and the
withdrawn order-\(28\) lower bound is not restored.
