...
case.  Arbitrary nonhomogeneous lower second-coordinate tiers, nonlinear
first-coordinate perturbations, and non-graph source surfaces remain
open weighted-lift directions.
